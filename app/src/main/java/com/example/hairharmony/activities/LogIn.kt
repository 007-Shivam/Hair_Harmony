...
fun LogIn(context: Context = LocalContext.current, navController: NavHostController) {
    ...
    Box() {
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.woman_with_long_hair),
                contentDescription = "logo",
                modifier = Modifier
                    .padding(top = 50.dp, bottom = 20.dp, start = 110.dp)
                    .fillMaxWidth()
            ...
            Text(text = stringResource(id = R.string.login),
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .wrapContentWidth(align = Alignment.Start)
                    .padding(start = 130.dp, bottom = 50.dp),
            )
